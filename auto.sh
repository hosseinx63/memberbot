...
echo -e "\e[01;34m                                    By TE(1)hossein_gh_79                              \e[00;37;40m"
echo ""
sleep 0.5
cat << EOF
 $f1██████████ ██████████ ██████████    ███████   ██████████$rst
...
if [ $? != 0 ]; then
  ...
  echo -e "$bld$f2 Github : https://github.com/hosseinx63/memberbot $rst"
  sleep 4
  exit 1
fi
sleep 1.5
while true ; do
  ...
  echo -e "$bld$f2 Github : https://github.com/hosseinx63/memberbot $rst"
  sleep 0.5
  echo -e "$bld$f2 Telegram  : t.me/hossein_gh_79 $rst"
  sleep 0.5
